...
} from '@appwrite.io/altair-graphql-core/build/subscriptions';
  ...
  constructor() {
    this.addProviderData({
      ...
      getProviderClass: async () =>
        (await import('@appwrite.io/altair-graphql-core/build/subscriptions/providers/ws'))
    ...
    this.addProviderData({
      ...
      getProviderClass: async () =>
        (
          await import(
            '@appwrite.io/altair-graphql-core/build/subscriptions/providers/graphql-ws'
          )
    ...
    this.addProviderData({
      ...
      getProviderClass: async () =>
        (
          await import(
            '@appwrite.io/altair-graphql-core/build/subscriptions/providers/app-sync'
          )
    ...
    this.addProviderData({
      ...
      getProviderClass: async () =>
        (
          await import(
            '@appwrite.io/altair-graphql-core/build/subscriptions/providers/action-cable'
          )
    ...
    this.addProviderData({
      ...
      getProviderClass: async () =>
        (
          await import(
            '@appwrite.io/altair-graphql-core/build/subscriptions/providers/graphql-sse'
          )
