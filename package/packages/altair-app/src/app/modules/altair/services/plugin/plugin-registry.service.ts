...
import {
  ...
  PluginManifest,
  PluginSource,
} from '@appwrite.io/altair-graphql-core/build/plugin/plugin.interfaces';
import { RootState } from '@appwrite.io/altair-graphql-core/build/types/state/state.interfaces';
import { PluginStateEntry } from '@appwrite.io/altair-graphql-core/build/types/state/local.interfaces';
import { PluginConstructor } from '@appwrite.io/altair-graphql-core/build/plugin/base';
